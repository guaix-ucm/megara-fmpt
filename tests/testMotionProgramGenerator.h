...
//---------------------------------------------------------------------------
//File: testMotionProgramGenerator.h
//Content: test for the module MotionProgramGenerator
//Author: Isaac Morales Durán
//---------------------------------------------------------------------------

#ifndef TEST_MotionProgramGenerator_H
#define TEST_MotionProgramGenerator_H

#include <cppunit/extensions/HelperMacros.h>

//build the class where define the test methods
class TestMotionProgramGenerator : public CppUnit::TestFixture
{
    //establish the test suit of Test
    CPPUNIT_TEST_SUITE(TestMotionProgramGenerator);
