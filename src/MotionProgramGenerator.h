//---------------------------------------------------------------------------
//Archivo: MotionProgramGenerator.h
//Contenido: generador de programas de movimiento
//Última actualización: 10/05/2014
...
class TMotionProgramGenerator : public TTargetPointList {
protected:
        //PARÁMETROS DE CONFIGURACIÓN DE LOS ALGORITMOS:
...
public:
        //PPROPIEDADES DE CONFIGURACIÓN:

        //Cuando hay varias funciones para realizar una misma función,
        //podrian usarse punteros a función, para seleccionar las funciones
        //que se quieran usar en cada ocasión.

        //salto que se da (en sentido negativo) en radianes, cada vez que
        //se detecta una colisión durante el abatimiento de los invasores
        //debe ser menor que cero
        //valor por defecto: -M_PI/36 rad
        double getdt_jmp(void) const {return __dt_jmp;}

        //Conviene que el salto venga dado en radianes y no en pasos
        //por varias razones:
        //      al cambiar el número de pasos el salto no debería variar;
        //      la posición del eje y los límites del dominio son guardados
        //      en radianes de modo que la comprobación de pertenencia
        //      al dominio en pasos puede introducir errores numéricos.

        //Nótese que cuando el salto corresponde a un número entero de pasos
        //los ejes no alteran su posición cuando se activa la cuantificación.
        ...
        TMotionProgramGenerator(TRoboticPositionerList *RoboticPositionerList);
        ...
        //DEFINICIÓN: distancia libre entre dos barreras (Df)
        //es la distancia entre los contornos de las barreras
        //menos el SPM de cada una:
        //  Df = Barrier1->Contour.DistanceMin(Barrier2->Contour) -
        //      Barrier1->SPM - Barrier2->SPM;
        //Cada barrera puede ser un brazo o formar parte de
        ...
        //DEFINICIÓN: tiempo libre mínimo de dos barreras (Tfmin)
        //es el tiempo de desplazamiento durante el cual
        //existe la garantía de que no pueden colisionar.
