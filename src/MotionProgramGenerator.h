...
protected:
    ...
    //  \param Outsiders list of operative outsiders RPs tobe segregated.
    //  \param[out] DisjointSets: list of disjoint sets.
    //  \return True if ...
    //  \pre All RPs in the list Outsiders shall be operative
    //  \pre All RPs in the list Outsiders shall be in insecurity positions.
    */
...
/** Generate a parking program online
  \param FMM the Fiber MOS Model
  \param p_1s the rotor 1 starting positions of all RPs of the FMM.
  \param p___3s the rotor 2 starting positions of all RPs of the FMM.
  \param RPids the identifiers of the RPs of the FMM to be disabled.
  \param[out] outputs
