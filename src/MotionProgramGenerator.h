...
//perform simulations. All MPs  generated by the MPG will be valid, is to say
//they will avoid dynamic collisions. For fullfill this purpose the MPG
//must use of the validation function, to assure that all generated MPs
//are valid.
