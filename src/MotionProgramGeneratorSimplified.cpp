...
//###########################################################################
//TMotionProgramGeneratorSimplified:
//###########################################################################

//GRAPHICAL PROPERTIES:

void TMotionProgramGeneratorSimplified::setSleepingTime(int _SleepingTime)
{
...
TMotionProgramGeneratorSimplified::TMotionProgramGeneratorSimplified(TRoboticPositionerList *_RoboticPositionerList) :
...
TMotionProgramGeneratorSimplified::~TMotionProgramGeneratorSimplified(void)
{
}
...
double TMotionProgramGeneratorSimplified::CalculateTf(TRoboticPositioner *RP1, TRoboticPositioner *RP2)
{
...
double TMotionProgramGeneratorSimplified::DisplacementToAvoidInvasion_JumpingMethod(double &Tfmin,
...
//Si no es posible encontrar una solución lanza ECantFindSolution.
double TMotionProgramGeneratorSimplified::DisplacementToAvoidInvasion_BinarySearch(double &Tfmin,
        TRoboticPositioner *RP)
{
        //COMPRUEBA LAS PRECONDICIONES:
...
//	devuelve verdadero.
//Si no es posible encontrar una solución lanza ECantFindSolution.
bool TMotionProgramGeneratorSimplified::TurnToSolveCollisions(double& Tfmin,
...
//	lanza una excepción EImproperArgument.
void TMotionProgramGeneratorSimplified::ProgramRetraction(TRoboticPositionerList &Outsiders)
{
...
void TMotionProgramGeneratorSimplified::RetractRetractiles(TRoboticPositionerList &Invaders,
...
void TMotionProgramGeneratorSimplified::RetractInvaders(TRoboticPositionerList &Invaders)
{
...
void TMotionProgramGeneratorSimplified::PopAbatibles(TRoboticPositionerList *Abatibles)
{
...
void TMotionProgramGeneratorSimplified::ProgramTurns(TRoboticPositionerList& TurnsInvaders,
                                           TRoboticPositionerList& Invaders)
{
    //Todos los posicionadores de la lista Invaders...
    for(int i=0; i<Invaders.getCount(); i++) {
...
TMessageList *TMotionProgramGeneratorSimplified::GetMessages(TRoboticPositionerList &RPL)
{
    TRoboticPositioner *RP;
...
void TMotionProgramGeneratorSimplified::GenerateDeployProgram(
...
void TMotionProgramGeneratorSimplified::GenerateDepositioningProgram(TMotionProgram &DP,
                                                           TRoboticPositionerList &Outsiders)
{
    //-------------------------------------------------------------------
...
void TMotionProgramGeneratorSimplified::GenerateGoDirectlyProgram(
...
char TMotionProgramGeneratorSimplified::GeneratePositioningChangeProgram(TMotionProgram &PCP,
        TVector<int> &indices)
{
        //-------------------------------------------------------------------
        //1. COMPRUEBA LAS PRECONDICIONES:
